 ...
 * @returns {object}
 */
function addCommandLineOptionsForVariablesUnassignedInConfigPlans(program, config) {
  return addCommandLineOptionsForVariables(program,
    getVariablesUnassignedInConfigPlans(config))
}
...
function getVariablesRequiredByCommands(commands, required) {
  return commands.reduce(flip2(getVariablesRequiredByCommand), required);
}
